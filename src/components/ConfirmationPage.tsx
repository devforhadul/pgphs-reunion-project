      ...
      <div className="relative z-10 w-full max-w-2xl px-4">
        <div className="bg-slate-800/80 backdrop-blur-md rounded-3xl p-8 md:p-12 border border-amber-500/20 shadow-[0_0_60px_rgba(245,158,11,0.15)] text-center transform transition-all hover:scale-[1.01]">
          ...
          <p className="text-slate-300 leading-relaxed mb-10 max-w-lg mx-auto">
            আপনার রেজিস্ট্রেশন তথ্য আমাদের কাছে জমা হয়েছে। আপনার পেমেন্ট ভেরিফাই করার পর আপনার ড্যাশবোর্ডে স্ট্যাটাস আপডেট হয়ে যাবে।
          </p>
          ...
          <div className="bg-slate-900/50 rounded-xl p-6 mb-10 border border-white/5 text-left">
             ...
             <ul className="space-y-4">
               <li className="flex items-start gap-3">
                 <span className="flex-shrink-0 w-6 h-6 bg-slate-700 rounded-full flex items-center justify-center text-xs font-bold text-white">1</span>
                 <p className="text-sm text-slate-300">
                   <strong className="text-white">Verification:</strong> আমাদের টিম আপনার পেমেন্ট Txn ID চেক করবে (২৪ ঘন্টার মধ্যে)।
                 </p>
               </li>
               <li className="flex items-start gap-3">
                 <span className="flex-shrink-0 w-6 h-6 bg-slate-700 rounded-full flex items-center justify-center text-xs font-bold text-white">2</span>
                 <p className="text-sm text-slate-300">
                   <strong className="text-white">Approval:</strong> পেমেন্ট কনফার্ম হলে আপনি SMS এবং ইমেইল পাবেন।
                 </p>
               </li>
               <li className="flex items-start gap-3">
                 <span className="flex-shrink-0 w-6 h-6 bg-slate-700 rounded-full flex items-center justify-center text-xs font-bold text-white">3</span>
                 <p className="text-sm text-slate-300">
                   <strong className="text-white">Ticket:</strong> এরপর ড্যাশবোর্ড থেকে আপনার ডিজিটাল এন্ট্রি টিকিট ডাউনলোড করতে পারবেন।
                 </p>
               </li>
             </ul>
          </div>
          ...
          <p className="mt-8 text-xs text-slate-500">
            Need help? Contact us at <a href="mailto:support@pgphsreunion.com" className="text-amber-500 hover:underline">pgphsalumniassociation@gmail.com</a>
          </p>
