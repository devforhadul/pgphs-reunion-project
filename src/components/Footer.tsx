    ...
    <footer className="bg-slate-900 text-white relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="space-y-6">
            ...
            <p className="text-slate-400 text-sm max-w-sm">
              ...
              evening of memories, laughter, and celebration. Let's create
              history together.
            </p>
            <div className="flex gap-4">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-slate-400 hover:bg-amber-500 hover:text-slate-900 transition-all duration-300"
              >
                <FaFacebook />
              </a>
            </div>
        ...
        <div className="border-t border-white/10 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center gap-4 text-xs text-slate-500">
          <p>
            © 2026 PGPHS Alumni Association. All rights reserved. V-
            {savedVersion}
          </p>
