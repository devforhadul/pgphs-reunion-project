...
import { FaGraduationCap, FaMapMarkerAlt, FaCalendarAlt, FaClock, FaHistory, FaQuoteRight, FaArrowRight } from "react-icons/fa";
import { MdEventSeat, MdRestaurantMenu, MdMusicNote, MdPhotoCamera } from "react-icons/md";
    ...
    <div className="min-h-screen bg-[#FDFBF7] text-slate-800 font-sans selection:bg-amber-200">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8 text-center lg:text-left z-10">
              ...
              <p className="text-lg lg:text-xl text-slate-300 max-w-2xl mx-auto lg:mx-0 leading-relaxed font-light">
                Join us for the historic 1st Alumni Reunion of PGPHS. A night of nostalgia, 
                networking, and celebrating the journey that started in our classrooms.
              </p>
            ...
            <div className="relative hidden lg:block">
               <div className="relative z-10 bg-gradient-to-br from-slate-800 to-slate-900 p-8 rounded-2xl border border-white/10 shadow-2xl rotate-3 hover:rotate-0 transition-all duration-500 group">
                  <div className="absolute -top-10 -right-10 text-9xl text-white/5 font-serif font-black select-none">2025</div>
                  <div className="flex justify-between items-start mb-8">
                     <div>
                        <p className="text-amber-500 font-bold text-sm tracking-widest uppercase">The Grand Reunion</p>
                        <h3 className="text-3xl text-white font-serif mt-2">Class of Legends</h3>
                     </div>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 z-20">
        <div className="bg-white rounded-xl shadow-xl border border-slate-100 p-8 grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-100">
            {[
                { icon: MdEventSeat, label: "Total Seats", value: "500+" },
                { icon: FaHistory, label: "Batches", value: "All" },
                { icon: MdRestaurantMenu, label: "Food", value: "Grand Dinner" },
        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="lg:w-1/2 relative">
                <div className="relative z-10">
                   <h2 className="text-amber-600 font-bold tracking-widest uppercase text-sm mb-3">Our Story</h2>
                   <h3 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6 font-serif">
                       Decades passed, <br/>but the <span className="underline decoration-amber-400 underline-offset-4 decoration-4">bond remains.</span>
                   </h3>
                   <p className="text-lg text-slate-600 leading-relaxed mb-6">
                       We are absolutely delighted to extend this special invitation to all PGPHS alumni. 
                       This milestone event brings together generations of graduates to celebrate our shared heritage.
                   </p>
                   <div className="p-6 bg-slate-50 border-l-4 border-amber-500 rounded-r-lg">
                       ...
                       <p className="italic text-slate-700 font-medium">
                           "No matter when you walked through those school gates - whether it was yesterday or decades ago - this reunion is your homecoming."
                       </p>
                   </div>
                </div>
            </div>
            ...
            <div className="lg:w-1/2 grid grid-cols-2 gap-4">
                <div className="space-y-4 mt-8">
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
                        <div className="w-12 h-12 bg-indigo-100 rounded-full flex items-center justify-center text-indigo-600 mb-4 text-xl">🤝</div>
                        <h4 className="font-bold text-slate-800 mb-2">Networking</h4>
                        <p className="text-sm text-slate-500">Connect with seniors and juniors from diverse professions.</p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
                        <div className="w-12 h-12 bg-pink-100 rounded-full flex items-center justify-center text-pink-600 mb-4 text-xl">📸</div>
                        <h4 className="font-bold text-slate-800 mb-2">Memories</h4>
                        <p className="text-sm text-slate-500">Photo booths and sessions to capture the moment.</p>
                    </div>
                </div>
                <div className="space-y-4">
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
                        <div className="w-12 h-12 bg-amber-100 rounded-full flex items-center justify-center text-amber-600 mb-4 text-xl">🍽️</div>
                        <h4 className="font-bold text-slate-800 mb-2">Grand Feast</h4>
                        <p className="text-sm text-slate-500">Delicious dinner buffet with premium refreshments.</p>
                    </div>
                    <div className="bg-white p-6 rounded-2xl shadow-lg border border-slate-100 hover:-translate-y-1 transition-transform duration-300">
                        <div className="w-12 h-12 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-600 mb-4 text-xl">🏆</div>
                        <h4 className="font-bold text-slate-800 mb-2">Ceremony</h4>
                        <p className="text-sm text-slate-500">Awards, recognition and cultural performances.</p>
                    </div>
                </div>
            </div>
        </div>
      ...
      <section className="py-24 bg-slate-900 text-white relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
            <div className="text-center mb-16">
                <span className="text-amber-500 font-bold tracking-widest uppercase text-sm">Save The Date</span>
                <h2 className="text-4xl md:text-5xl font-bold mt-2 mb-4 font-serif">Event Schedule</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-colors">
                    ...
                    <h3 className="text-2xl font-bold mb-2">January 2, 2026</h3>
                    <p className="text-slate-400">Wednesday</p>
                    <div className="mt-6 inline-block px-3 py-1 bg-amber-500/20 text-amber-300 rounded text-xs font-bold uppercase tracking-wider">Confirmed</div>
                </div>
                ...
                <div className="bg-gradient-to-br from-indigo-600 to-indigo-800 p-8 rounded-3xl shadow-2xl transform md:-translate-y-4">
                    ...
                    <h3 className="text-2xl font-bold mb-2">06:00 PM</h3>
                    <p className="text-indigo-200">Gates Open</p>
                    <div className="mt-6 border-t border-white/20 pt-4">
                        <p className="text-sm font-medium">Until 11:00 PM</p>
                        <p className="text-xs text-indigo-200 mt-1">5 Hours of Non-stop Celebration</p>
                    </div>
                </div>
                ...
                <div className="bg-white/5 backdrop-blur-sm border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-colors">
                    ...
                    <div className="mt-6 inline-block px-3 py-1 bg-pink-500/20 text-pink-300 rounded text-xs font-bold uppercase tracking-wider">Map View</div>
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-[#FDFBF7]">
         <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-12">
                <h2 className="text-3xl md:text-5xl font-bold text-slate-900 font-serif">Get Your Pass</h2>
            </div>
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col md:flex-row border border-slate-200">
                ...
                <div className="flex-1 p-8 md:p-12 relative overflow-hidden">
                    ...
                    <div className="relative z-10">
                        <div className="flex items-center gap-3 mb-6">
                            <span className="px-3 py-1 bg-slate-900 text-white text-xs font-bold uppercase rounded">General</span>
                            <span className="px-3 py-1 bg-amber-100 text-amber-800 text-xs font-bold uppercase rounded">Limited Seats</span>
                        </div>
                        <h3 className="text-4xl font-bold text-slate-900 mb-2">Reunion Entry Pass</h3>
                        <p className="text-slate-500 mb-8">Full access to the event, dinner, and alumni kit.</p>
                        
                        <ul className="space-y-3 mb-8">
                            {['Exclusive Alumni T-Shirt', 'Gala Dinner Buffet', 'Gift Hamper', 'Cultural Program Access'].map((item, i) => (
                        ...
                        <Link to="/register" className="inline-block bg-slate-900 text-white px-8 py-4 rounded-xl font-bold hover:bg-slate-800 transition-colors w-full md:w-auto text-center">
                            Register for ৳1000
                        </Link>
                    </div>
                </div>
                ...
                <div className="bg-slate-900 p-8 md:w-64 flex flex-col items-center justify-center text-center relative overflow-hidden">
                     ...
                     <p className="text-white/60 text-xs uppercase tracking-widest mb-1">Fee</p>
      ...
      <section className="py-20 border-t border-slate-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <p className="text-slate-500 font-medium mb-8 uppercase tracking-widest text-sm">Secure Payment Partners</p>
            <div className="flex flex-wrap justify-center gap-8 items-center grayscale hover:grayscale-0 transition-all duration-500">
                <div className="group bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all w-64">
                    <img src={bkash_logo} alt="bKash" className="h-16 mx-auto object-contain mb-3" />
                    <p className="text-slate-400 text-xs font-mono group-hover:text-pink-600">01984839526 (Merchant)</p>
                </div>
                <div className="group bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all w-64">
                    <img src={nagad_logo} alt="Nagad" className="h-16 mx-auto object-contain mb-3" />
                    <p className="text-slate-400 text-xs font-mono group-hover:text-orange-600">01984839526 (Merchant)</p>
                </div>
                <div className="group bg-white p-6 rounded-xl border border-slate-100 shadow-sm hover:shadow-md transition-all w-64">
                    <img src={rocket_logo} alt="Rocket" className="h-16 mx-auto object-contain mb-3" />
                    <p className="text-slate-400 text-xs font-mono group-hover:text-purple-600">01984839526 (Merchant)</p>
                </div>
            </div>
        </div>
      </section>
      ...
      <section className="py-24 bg-slate-900 text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
            <h2 className="text-4xl md:text-6xl font-bold text-white mb-6 font-serif">Ready to reconnect?</h2>
            <p className="text-slate-400 text-xl mb-10">Don't let this once-in-a-lifetime opportunity pass you by.</p>
            <Link
              to="/register"
